...
toggle.addEventListener("click", function(){
    sidebar.classList.toggle("show-sidebar"); // sidebar 요소의 클래스 목록에 show-sidebar 클래스가 있으면 제거하고, 없으면 추가합니다.
});

// closeBtn 요소에 대한 클릭 이벤트 리스너를 추가합니다.

closeBtn.addEventListener("click", function(){
    sidebar.classList.remove("show-sidebar"); // sidebar 요소의 클래스 목록에서 "show-sidebar" 클래스를 제거합니다.
});